...
export default function MeetingNotesPdfModal() {
  return (
    <>
      <Switch>
        <Route path='/workspace/:id/details/:spaceKey/addmeetingnotes/readpdf/readfullpage'>
          <MeetingFullPagePdf />
        </Route>
...
const MeetingPdfModalComponent = () => {
  ...
  return (
    ...
    >
      ...
      >
        <Link
          to={{
            pathname: `/workspace/${param.id}/details/${param.spaceKey}/addmeetingnotes/readpdf/readfullpage`,

...
import InternshipsFullPageDoc from './InternshipsFullPageDoc'
...
export default function InternshipPdfModal() {
  return (
    <>
      <Switch>
        <Route path='/internships/docs/:internshipID/readdoc/fullpage'>
          <InternshipsFullPageDoc />
        </Route>
  ...
  return (
    ...
    >
      ...
      >
        <Link
          to={{
            pathname: `/internships/docs/${param.internshipID}/readdoc/fullpage`,
            state: {

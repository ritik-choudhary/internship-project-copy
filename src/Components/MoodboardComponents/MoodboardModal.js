...
export default function MoodboardModal(props) {
  return (
    <WorkspaceConsumer>
      {(value) => {
        return (
          <MoodboardModalComponent
            value={value}
            {...props}
          ></MoodboardModalComponent>
        )
...
function MoodboardModalComponent(props) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {isEditing ? 'Edit Moodboard' : 'Add new Moodboard'}
        </h3>
      ...
      <form
        ...
        onSubmit={(e) => {
          ...
          if (!isEditing) {
            ...
            value.editMoodboard(param.id, param.spaceKey, param.moodboardID, {
              title: moodboardName,
              image: thumbnail ? preview : selectedMoodboard.image,
            })
          }
